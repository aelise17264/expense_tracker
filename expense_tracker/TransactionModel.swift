...
extension Category {
    ...
    static let financeCharge = Category(id: 402, name: "Finanace Charge", icon: .hand_holding_usd, mainCategoryId: 4)
    ...
    static let homeSupplies = Category(id: 602, name: "House Supplies", icon: .lightbulb, mainCategoryId: 6)
